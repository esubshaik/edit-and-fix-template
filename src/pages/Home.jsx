...
export default function PNG2JPEG() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <p className="text-gray-600 text-center mb-6">
        Upload one or more PNG files and download them as JPG.
      </p>
      ...
      >
        ...
        {files.length ? (
          ...
          <p className="text-gray-400">Drag & drop PNG files here, or click to select</p>
        )}
      </div>
      ...
      {files.length > 0 && (
        ...
        >
          {loading ? "Converting..." : "Convert & Download JPGs"}
        </button>
      )}

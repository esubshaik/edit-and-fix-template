...
export default function PDF2ODT() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/convert-pdf-odt", formData, {
        responseType: "blob",
      });
      ...
      link.href = url;
      link.setAttribute("download", `${file.name.replace(".pdf", "")}.odt`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <p className="text-gray-600 text-center mb-8 max-w-lg">
        Upload your PDF file and instantly get an ODT (OpenDocument Text) version. Maximum file size 50MB.
      </p>
      ...
      {file && (
        ...
        >
          {loading ? "Converting..." : "Convert & Download ODT"}
        </button>
      )}

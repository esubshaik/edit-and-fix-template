...
export default function PPTX2PDF() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/convert-pptx", formData, {
        responseType: "blob",
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <p className="text-gray-600 text-center mb-8 max-w-lg">
        Upload your PowerPoint file (.pptx) and instantly get a PDF version. Maximum file size 50MB.
      </p>
      ...
      >
        ...
        {file ? (
          ...
          <p className="text-indigo-600 font-semibold">Drop your PPTX file here...</p>
        ) : (
          <p className="text-gray-400">
            Drag & drop a PPTX here, or click to select a file
          </p>
        )}
      </div>

  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <p className="text-gray-600 text-center mb-8 max-w-lg">
        Upload your Word document (.docx) and get a high-quality PDF instantly. Maximum file size 50MB.
      </p>
      ...
      >
        ...
        {file ? (
          ...
          <p className="text-indigo-600 font-semibold">Drop your DOCX file here...</p>
        ) : (
          <p className="text-gray-400">
            Drag & drop a Word document here, or click to select a file
          </p>
        )}
      </div>
